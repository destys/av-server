...
export interface ApiMainServiceMainService extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    SEO: Attribute.Component<'seo.meta-fields'>;
    service_2_types: Attribute.Relation<
...
export interface ApiTypeServiceTypeService extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    SEO: Attribute.Component<'seo.meta-fields'>;
    service_1_main: Attribute.Relation<
      'api::type-service.type-service',
      'manyToOne',
      'api::main-service.main-service'
    >;
